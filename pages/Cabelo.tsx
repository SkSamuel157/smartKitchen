...
export function Salao() {
  ...
  async function gerarReceita() {
    ...
    const prompt = `Sugira um Corte e Tratamento detalhado para o ${ocasiao} usando os ingredientes: ${ingr1}, ${ingr2} e ${ingr3} e pesquise tudo no YouTube. Caso encontre, informe o link.`;
  ...
  return (
    <View style={ESTILOS.container}>
      ...
      <Text style={ESTILOS.header}>Beautiful hair</Text>
      <View style={ESTILOS.form}>
        <Text style={ESTILOS.label}>Insira as seguintes infos.:</Text>
        <TextInput
          placeholder="Tipo Cabelo (Liso, Cacheado, Crespos)"
          style={ESTILOS.input}
          value={ingr1}
          onChangeText={(texto) => defIngr1(texto)}
        />
        <TextInput
          placeholder="Penteado (Black Power, Dedo liss...)"
          style={ESTILOS.input}
          value={ingr2}
          onChangeText={(texto) => defIngr2(texto)}
        />
        <TextInput
          placeholder="Produto (Creme, Gel...)"
          style={ESTILOS.input}
          value={ingr3}
        ...
        <TextInput
          placeholder="Tratamento Capilar (Finalização, Hidratação, Reconstrução)"
          style={ESTILOS.input}
          value={ocasiao}
      ...
      <TouchableOpacity style={ESTILOS.button} onPress={gerarReceita}>
        <Text style={ESTILOS.buttonText}>Projeto Hair</Text>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 24, marginTop: 4, }} style={ESTILOS.containerScroll} showsVerticalScrollIndicator={false} >
        {load && (
          <View style={ESTILOS.content}>
            <Text style={ESTILOS.title}>Produzindo...</Text>
        ...
        {receita && (
          <View style={ESTILOS.content}>
            <Text style={ESTILOS.title}>Seu Novo Corte 👇</Text>
